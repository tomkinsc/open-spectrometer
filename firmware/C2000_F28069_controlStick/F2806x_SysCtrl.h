...
struct PLLSTS_BITS {     // bits description
	...
	Uint16	DIVSEL:2;			// 8:07	Divide select (/4 default)
	Uint16	rsvd2:6;			// 14:09	Reserved
...
struct CLKCTL_BITS {     // bits description
	...
	Uint16	TMR2CLKSRCSEL:2;		// 4:03	CPU timer 2 clock source select bit
	Uint16	TMR2CLKPRESCALE:3;		// 7:05	CPU timer 2 clock pre-scale value
...
struct INTOSC1TRIM_BITS {     // bits description
	Uint16	COARSETRIM:8;		// 7:00	8-bit coarse trim value
	Uint16	rsvd1:1;			// 8	Reserved
	Uint16	FINETRIM:6;			// 14:09	6-bit fine trim value
...
struct LOSPCP_BITS {     // bits description
	Uint16	LSPCLK:3;			// 2:00	Rate relative to SYSCLKOUT
...
struct PLLCR_BITS {     // bits description
	...
	Uint16	rsvd1:11;			// 15:04	Reserved
};
...
struct LPMCR0_BITS {     // bits description
	Uint16	LPM:2;				// 1:00	Set the low power mode
	Uint16	QUALSTDBY:6;		// 7:02	Qualification
	Uint16	rsvd1:7;			// 14:08	Reserved
...
struct EPWMCFG_BITS {     // bits description
	Uint16	CONFIG:1;			// 0	EPWM DMA Enable Bit
...
struct SYS_CTRL_REGS {
	...
	Uint16					rsvd1;			// Reserved
	union	INTOSC2TRIM_REG	INTOSC2TRIM;	// Internal 32KHz Oscillator 2 Trim Register
