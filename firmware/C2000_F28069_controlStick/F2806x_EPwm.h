...
// Checkin $Date: January 4, 2011   10:08:07 $
//###########################################################################
//
// FILE:   F2806x_Epwm.h
//
...
struct TBCTL_BITS {     // bits description
	Uint16	CTRMODE:2;			// 1:00	Counter Mode
...
struct CMPCTL_BITS {     // bits description
	Uint16	LOADAMODE:2;		// 1:00	Active Compare A Load
	Uint16	LOADBMODE:2;		// 3:02	Active Compare B Load
...
struct DBCTL_BITS {     // bits description
	Uint16	OUT_MODE:2;			// 1:00	Dead Band Output Mode Control
	Uint16	POLSEL:2;			// 3:02	Polarity Select Control
	Uint16	IN_MODE:2;			// 5:04	Dead Band Input Select Mode Control
	Uint16	rsvd1:9;			// 14:06	Reserved
...
struct TZCTL_BITS {     // bits description
	Uint16	TZA:2;			// 1:00	TZ1 to TZ6 Trip Action On EPWMxA
	Uint16	TZB:2;			// 3:02	TZ1 to TZ6 Trip Action On EPWMxB
	Uint16	DCAEVT1:2;		// 5:04	EPWMxA action on DCAEVT1
	Uint16	DCAEVT2:2;		// 7:06	EPWMxA action on DCAEVT2
	Uint16	DCBEVT1:2;		// 9:08	EPWMxB action on DCBEVT1
...
struct ETSEL_BITS {     // bits description
	Uint16	INTSEL:3;			// 2:00	EPWMxINTn Select
	Uint16	INTEN:1;			// 3	EPWMxINTn Enable
	Uint16	rsvd1:4;			// 7:04	Reserved
	Uint16	SOCASEL:3;			// 10:08	Start of Conversion A Select
...
struct ETPS_BITS {     // bits description
	Uint16	INTPRD:2;			// 1:00	EPWMxINTn Period Select
	Uint16	INTCNT:2;			// 3:02	EPWMxINTn Counter Register
	Uint16	rsvd1:4;			// 7:04	Reserved
	Uint16	SOCAPRD:2;			// 9:08	EPWMxSOCA Period Select
...
struct ETFLG_BITS {     // bits description
	...
	Uint16	rsvd2:12;		// 15:04	Reserved
};
...
struct PCCTL_BITS {     // bits description
	...
	Uint16	OSHTWTH:4;			// 4:01	One-shot pulse width
	Uint16	CHPFREQ:3;			// 7:05	Chopping clock frequency
	Uint16	CHPDUTY:3;			// 10:08	Chopping clock Duty cycle
...
struct HRCNFG_BITS {     // bits description
	Uint16	EDGMODE:2;			// 1:00	ePWMxA Edge Mode Select Bits
	Uint16	CTLMODE:1;			// 2	ePWMxA Control Mode Select Bits
	Uint16	HRLOAD:2;			// 4:03	ePWMxA Shadow Mode Select Bits
...
struct DCFCTL_BITS {     // bits description
	Uint16	SRCSEL:2;			// 1:00	Filter Block Signal Source Select
	Uint16	BLANKE:1;			// 2	Blanking Enable/Disable
	Uint16	BLANKINV:1;			// 3	Blanking Window Inversion
	Uint16	PULSESEL:2;			// 5:04	Pulse Select for Blanking & Capture Alignment
