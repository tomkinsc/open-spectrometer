...
// Checkin $Date: January 4, 2011   10:08:05 $
//###########################################################################
//
// FILE:   F2806x_Dma.h
//
...
struct DEBUGCTRL_BITS {     // bits description
	Uint16	rsvd1:15;		// 14:00	Reserved
...
struct PRIORITYSTAT_BITS {     // bits description
	Uint16	ACTIVESTS:3;		// 2:00	Active Channel Status Bits
	Uint16	rsvd1:1;			// 3	Reserved
	Uint16	ACTIVESTS_SHADOW:3;	// 6:04	Active Channel Status Shadow Bits
...
struct BURST_SIZE_BITS {     // bits description
	...
	Uint16	rsvd1:11;			// 15:05	Reserved
};
...
struct BURST_COUNT_BITS {     // bits description
	Uint16	BURSTCOUNT:5;		// 4:00	Burst Transfer Count
...
struct CH_REGS {
	...
	Uint32					ST_BEG_ADDR_ACTIVE;		// Destination Begin Address Active Register
